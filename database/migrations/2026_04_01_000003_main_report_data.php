...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasTable('jumlah_merchant_detail')) {
            ...
            $table->string('NAMA_KANCA')->nullable()->index();
            $table->string('KODE_UKER')->nullable();
            $table->string('NAMA_UKER')->nullable()->index();
            ...
            $table->decimal('AKUMULASI_SALES_VOLUME', 25, 2)->nullable();
            ...
            $table->decimal('KARTU_SALES_VOLUME_ON_US', 25, 2)->nullable();
            $table->decimal('KARTU_SALES_VOLUME_OFF_US', 25, 2)->nullable();
            $table->decimal('SALES_VOLUME_LAINNYA', 25, 2)->nullable();
            $table->string('KET_MCC')->nullable();
            $table->string('KODE_MCC')->nullable();
            $table->string('NOREK')->nullable();
            $table->string('CIFNO')->nullable();
            $table->decimal('SALDO_POSISI', 25, 2)->nullable();
            $table->decimal('RATAS_SALDO', 25, 2)->nullable();
            $table->decimal('SALDO_POSISI_BY_CIF', 25, 2)->nullable();
            $table->decimal('RATAS_SALDO_BY_CIF', 25, 2)->nullable();
            $table->dateTime('TGL_APPROVAL')->nullable();
            $table->string('NILAI')->nullable();
            $table->string('SOURCE')->nullable();
            $table->decimal('SALES_VOLUME_MID', 25, 2)->nullable();
