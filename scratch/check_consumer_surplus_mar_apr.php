...
$periods = [
    '2026-03-31' => ['prev' => '2026-02-28', 'start' => '2026-03-01'],
    '2026-04-30' => ['prev' => '2026-03-31', 'start' => '2026-04-01'],
];

$rmKey = '00187063 - RONA ROHANA TALIBATA';

foreach ($periods as $period => $meta) {
    $previousPeriod = $meta['prev'];
    ...
    echo "Period: $period | Current Base count: " . $currentBase->count() . "\n";
    ...
    echo "Period: $period | Computed surplus_deb: $surplusDeb, surplus_os: $surplusOs\n\n";
}
