            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="d-flex align-items-start flex-wrap mb-3">
                        <div class="dashboard-brand-mark mr-3 mb-3">
...
<div class="row">
    ...
    <div class="col-lg-4">
        <div class="card soft-panel mb-4 dash-entrance" data-enter-order="9">
            <div class="card-header bg-white border-0 pt-4 px-4">
        ...
        <div class="card soft-panel mb-4 dash-entrance" data-enter-order="10">
            <div class="card-header bg-white border-0 pt-4 px-4">
