...
<div class="card import-upload-card border-0 mb-4">
    ...
    <form id="form-import" method="POST" action="{{ route('import.upload') }}" enctype="multipart/form-data" data-prepare-preview-url="" data-upload-limits-url="{{ route('import.upload-limits') }}" data-chunked-upload="" data-chunk-init-url="" data-chunk-upload-url="" data-chunk-finalize-url="">
        ...
        <div class="import-upload-card__body" style="background: #f8fafc;">
            <div class="row align-items-stretch">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <div class="import-step-panel">
                        <span class="import-step-badge import-step-badge--step1">1. Pilih Report</span>
                        
                        <div class="form-group mb-0">
                            <label class="font-weight-bold text-dark mb-2" style="font-size: 0.95rem;">Jenis Report</label>
                        ...
                        <div id="form-periode" class="form-group mt-3" style="display: none;">
                            <label id="periode-label" class="font-weight-bold text-dark mb-2" style="font-size: 0.95rem;">
                                <i class="fas fa-calendar-alt text-primary mr-1"></i> Periode
                            </label>
                            <input type="date" id="periode_input" name="periode" class="form-control">
                            <small id="periode-help" class="text-muted mt-2 d-block" style="font-size: 0.85rem;">Wajib untuk report tertentu.</small>
                        </div>
                    </div>
                </div>
...
<style>
    ...
    .import-step-badge--step1 {
        background: rgba(59, 130, 246, 0.1);
        color: #2563eb;
    }

    .import-step-badge--step2 {
