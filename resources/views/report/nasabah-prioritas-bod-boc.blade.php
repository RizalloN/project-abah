...
<style>
    .content-wrapper .table-container table.table-report.bodboc-no-hover tbody tr:hover > td,
    .content-wrapper .table-container table.table-report.bodboc-no-hover tbody tr:hover > th {
        background-color: #ffffff !important;
        background-image: none !important;
    }
    .content-wrapper .table-container table.table-report.bodboc-no-hover tbody tr:hover > .sticky-col {
        background-color: #ffffff !important;
    }
    .content-wrapper .table-container table.table-report.bodboc-no-hover tbody tr.row-total > td,
    .content-wrapper .table-container table.table-report.bodboc-no-hover tbody tr.row-total > th,
    .content-wrapper .table-container table.table-report.bodboc-no-hover tbody tr.row-total:hover > td,
    .content-wrapper .table-container table.table-report.bodboc-no-hover tbody tr.row-total:hover > th {
        background-color: var(--table-header-bg) !important;
        background-image: none !important;
        color: var(--table-header-text) !important;
        font-weight: 700;
    }
    .content-wrapper .table-container table.table-report.bodboc-no-hover tbody tr.row-total:hover > .sticky-col {
        background-color: var(--table-header-bg) !important;
    }
</style>
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="form-group mb-0">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control report-input border-left-0 pl-0" value="{{ $sourceLabel }}" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
    ...
    <div class="report-card mb-4">
        ...
        <div class="card-body p-4 bg-white">
            <div class="table-container">
                <table class="table table-report bodboc-no-hover m-0">
                    <thead>
                        <tr>
