<div class="rm-mikro-table-wrap">
    <table class="rm-mikro-table">
        <thead>
            ...
            <tr>
                <th>Lancar Deb</th><th>OS Juta</th><th>SML Deb</th><th>OS Juta</th><th>NPL Deb</th><th>OS Juta</th><th>Total Deb</th><th>OS Juta</th><th>Deb</th><th>Rp.Juta</th>
            </tr>
        </thead>
        <tbody>
            @if ($total)
                <tr class="rm-mikro-total">
                    <td class="text-center">1</td><td>AREA 6</td><td>GRAND TOTAL</td><td>AREA 6</td><td>-</td>
            ...
            @forelse ($rows as $index => $row)
                <tr>
                    <td class="text-center">{{ $index + ($total ? 2 : 1) }}</td><td class="strong">{{ $row['bc'] }}</td><td>{{ $row['unit'] }}</td><td class="strong">{{ $row['cabang'] }}</td><td>{{ $row['pic_mbm'] }}</td>
