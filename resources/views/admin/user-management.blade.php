...
<div class="row">
    ...
    <div class="col-xl-8 mb-4">
        ...
        <div class="card shadow-sm border-0 user-management-card">
            <div class="card-header bg-white border-0 user-management-card__header">
...
<style>
    ...
    .user-management-hero__glow{position:absolute;top:-48px;right:-30px;width:170px;height:170px;border-radius:999px;background:rgba(14,165,233,.16);filter:blur(10px)}
    .user-management-hero__eyebrow,.user-management-card__eyebrow{display:inline-block;margin-bottom:.55rem;padding:.35rem .7rem;border-radius:999px;font-size:.72rem;font-weight:800;letter-spacing:.08em;text-transform:uppercase}
    .user-management-hero__eyebrow{color:#1d4ed8;background:rgba(255,255,255,.72);border:1px solid rgba(37,99,235,.16)}
    .user-management-hero__title{color:#0f3f8c;font-size:1.4rem;font-weight:800;letter-spacing:-.03em;margin-bottom:.35rem}
    .user-management-hero__text{color:#31527c;line-height:1.7;max-width:700px}
    .user-management-hero__badge{display:inline-flex;align-items:center;min-height:48px;padding:.8rem 1rem;border-radius:18px;background:rgba(255,255,255,.84);border:1px solid rgba(37,99,235,.14);color:#0f3f8c;font-weight:700;box-shadow:0 18px 32px -24px rgba(29,78,216,.3)}
    .user-management-flash{padding:1rem 1.1rem;border-radius:18px;font-weight:700}
    .user-management-flash--success{background:rgba(220,252,231,.85);border:1px solid rgba(34,197,94,.2);color:#166534}
    .user-management-flash--danger{background:rgba(254,226,226,.88);border:1px solid rgba(239,68,68,.18);color:#b91c1c}
    .user-management-card{border-radius:26px;overflow:hidden;box-shadow:0 28px 60px -40px rgba(15,23,42,.32)!important}
    .user-management-card__header{padding:1.45rem 1.5rem 1rem;background:radial-gradient(circle at top left,rgba(59,130,246,.09),transparent 28%),linear-gradient(180deg,#fff 0%,#f8fafc 100%)}
    .user-management-card__eyebrow{color:#1d4ed8;background:rgba(37,99,235,.08)}
    .user-management-card__subtitle{color:#64748b;max-width:700px;line-height:1.6}
    .user-management-card__body{padding:1.5rem}
    .user-management-stat{height:100%;padding:1rem 1.05rem;border-radius:20px;background:linear-gradient(180deg,#fff 0%,#f8fbff 100%);border:1px solid rgba(148,163,184,.22)}
    .user-management-stat small{display:block;color:#64748b;font-size:.78rem;font-weight:700;text-transform:uppercase;letter-spacing:.08em;margin-bottom:.45rem}
    .user-management-stat strong{display:block;color:#0f172a;font-size:1.05rem;font-weight:800;line-height:1.45}
    .user-management-input{min-height:48px;border-radius:16px;border:1px solid #c7dcfb;background:#f4f9ff}
    .user-management-input:focus{border-color:#307fe2;background:#fff;box-shadow:0 0 0 4px rgba(48,127,226,.16)}
    .user-management-btn,.user-management-modal__btn{min-height:48px;border-radius:16px;font-weight:800}
    .user-management-table-wrap{border:1px solid rgba(148,163,184,.18);border-radius:22px;overflow:hidden;background:#fff}
    .user-management-table thead th{background:linear-gradient(180deg,#f8fafc 0%,#eef4ff 100%);border-bottom:1px solid rgba(148,163,184,.18);color:#334155;font-size:.8rem;font-weight:800;letter-spacing:.04em;text-transform:uppercase;padding:1rem}
    .user-management-table tbody td{padding:1rem;border-top:1px solid rgba(226,232,240,.8);vertical-align:middle}
    .user-management-usercell{display:flex;align-items:center;gap:.9rem}
    .user-management-avatar{display:inline-flex;align-items:center;justify-content:center;width:46px;height:46px;border-radius:15px;background:linear-gradient(140deg,#0857c3,#307fe2);color:#fff;font-weight:800;box-shadow:0 14px 30px -18px rgba(8,87,195,.55)}
    .user-management-usercell__name{font-weight:800;color:#0f172a}
    .user-management-usercell__meta{font-size:.84rem;color:#64748b}
    .user-management-pill{display:inline-flex;align-items:center;justify-content:center;min-width:84px;padding:.45rem .8rem;border-radius:999px;font-weight:800;font-size:.8rem}
    .user-management-pill--plain{background:rgba(15,23,42,.06);color:#334155}
    .user-management-pill--admin{background:rgba(219,234,254,.88);color:#1d4ed8}
    .user-management-pill--user{background:rgba(226,232,240,.8);color:#475569}
    .user-management-action{border-radius:12px;font-weight:700}
    .user-management-modal{border:1px solid rgba(226,232,240,.95);border-radius:28px;box-shadow:0 30px 80px -35px rgba(15,23,42,.35)}
    @media (max-width:767.98px){.user-management-hero,.user-management-card__header,.user-management-card__body{padding-left:1rem;padding-right:1rem}.user-management-hero__title{font-size:1.15rem}.user-management-hero__badge,.user-management-btn{width:100%}.user-management-table thead th,.user-management-table tbody td{padding:.8rem}}
</style>
@endsection
