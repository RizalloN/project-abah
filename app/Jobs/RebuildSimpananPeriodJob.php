...
class RebuildSimpananPeriodJob implements ShouldQueue
{
    ...
    public function middleware(): array
    {
        return [
            ...
            (new WithoutOverlapping('snapshot:dashboard_simpanan:' . $this->period))
                ->releaseAfter(60)
    ...
    public function handle(ReportSnapshotBuilder $builder): void
    {
        ...
        try {
            ...
            Log::info('RebuildSimpananPeriodJob selesai', [
                'period' => $this->period,
            ...
            Log::error('RebuildSimpananPeriodJob gagal', [
                'period' => $this->period,
                'duration_seconds' => $duration,
                'error' => $e->getMessage(),
            ]);
        ...
        try {
            Cache::put(
                ...
                [
                    ...
                    'job_type' => 'snapshot_simpanan_period',
                    'period' => $this->period,
                ],
                now()->addHours(1)
            );
