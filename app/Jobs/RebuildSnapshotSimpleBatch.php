...
/**
 * Parallel job to rebuild Dashboard Simpanan snapshot
 *
 * Part of 4-job batch that runs in parallel:
 * - RebuildSnapshotSimpleBatch (this job)
 * - RebuildSnapshotHarianBatch
 * - RebuildSnapshotDormantBatch
 * - RebuildSnapshotRasioBatch
 *
 * Total time: ~8 minutes (vs. 40 min sequential)
 */
