...
def stage_ssa_pinjaman(config: dict) -> None:
    ...
    try:
        ...
        if mode == "preview":
            send_progress(86, "Menulis preview CSV SSA Pinjaman...", written_rows, total_data_rows, 0, "", "polars")
            ...
            send_progress(86, "Menulis CSV bulk load SSA Pinjaman...", written_rows, total_data_rows, 0, "", "polars")
