...
| `KpiRmSmeDashboardService` | class | 20 | `app/Services/Reports/KpiRmSmeDashboardService.php:7` |
...
| `associateRows` | method | 4 | `app/Services/Reports/KpiRmSmeDashboardService.php:232` |
| `branchCode` | method | 4 | `app/Services/Reports/KpiRmSmeDashboardService.php:279` |
| `cleanOrganization` | method | 4 | `app/Services/Reports/KpiRmSmeDashboardService.php:299` |
| `hasAuthoritativeMantriReference` | method | 4 | `app/Services/Reports/KpiPersonnelReferenceSyncService.php:418` |
| `identity` | method | 4 | `app/Services/Reports/KpiRmSmeDashboardService.php:254` |
| `metricValues` | method | 4 | `app/Services/Reports/KpiRmSmeDashboardService.php:312` |
